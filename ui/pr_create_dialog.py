...
logger = get_logger("ui.pr_create_dialog")
        ...
        if result["success"]:
            ...
            if pr_number and selected_assignees:
                ...
                if not assignee_result["success"]:
                    logger.warning("Failed to add assignees: %s", assignee_result['error'])
            ...
            if pr_number and selected_labels:
                ...
                if not label_result["success"]:
                    logger.warning("Failed to add labels: %s", label_result['error'])
